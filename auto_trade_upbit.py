...
def auto_trade():
    ...
    buy_price_threshold = 40000000  # 매수 기준 (40,000,000 KRW)
    ...
    while True:
        ...
        if current_price >= sell_price_threshold:
            ...
            if balance_btc > 0.001:  # 최소 보유량 이상일 경우
                sell(ticker, balance_btc)
            else:
                print("BTC 잔고가 없거나 잘못된 값입니다.")

        # 매수 조건: 가격이 40,000,000 KRW 이하일 경우 10,000 KRW 매수
